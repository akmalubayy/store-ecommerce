              ...
              <a href="{{ route('detail', $product->slug) }}" class="component-products d-block">
                <div class="products-thumbnail">
                  <div
                    ...
                    {{-- Ada dua cara untuk tentukan kondisi if, dengan ternary seperti di atas atau di bawah if biasa --}}

                    {{-- style="
                        @if ($product->galleries->count())
                            background-image: url('{{ Storage::url($product->galleries->first()->photo_url) }}')
                        @else
                            background-image: url('./images/img-no-available.jpg');
                        @endif
                    " --}}
                  </div>
                </div>

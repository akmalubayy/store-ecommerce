...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        return redirect()->route('product.index')->with('sukses','Data Product Berhasil Ditambah');
    }
    ...
    public function update(ProductRequest $request, $id)
    {
        ...
        return redirect()->route('product.index')->with('sukses','Data Produk Berhasil Diupdate');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('product.index')->with('sukses','Data Produk Berhasil Dihapus');
    }
}

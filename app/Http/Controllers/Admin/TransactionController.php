...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        if(request()->ajax()) {
            ...
            ->editColumn('created_at', function ($user) {
                       return [
                          'display' => e($user->created_at->toDayDateTimeString()),
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('transaction.index')->with('sukses','Data Produk Berhasil Diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('transaction.index')->with('sukses','Data Produk Berhasil Dihapus');
    }
}
